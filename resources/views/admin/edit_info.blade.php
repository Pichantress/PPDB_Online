...
@section('title', 'Admin Dashboard - Edit Siswa')
...
@section('main')
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title mb-4">Edit Informasi</h4>
                @if (session('error'))
                ...
                @endif
                <form class="forms-sample" method="POST" action="{{ route('updateInfo') }}">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="Agenda" name="Agenda" required>{{ old('Agenda', $data->Agenda) }}</textarea>
                    </div>
