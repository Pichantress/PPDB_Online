...
@section('title', 'Admin Dashboard - View Pendaftar')
...
@section('main')
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-header">Registrant Page</div>
            <div class="card-body">
            ...
            <div class="card-footer d-flex justify-content-end">
                <form onsubmit="return verificationConfirmation(event);"
                    action="{{ route('markAsPending', ['id' => $data->id]) }}" method="post">
                    @csrf
                    <button class="btn btn-md btn-success">Verifikasi</button>
                    <a href="/datapendaftar" class="btn btn-light">Kembali</a>
                </form>
                <form id="failedForm" action="{{ route('markAsFailed', ['id' => $data->id]) }}" method="post"
                    style="display: none;">
                    @csrf
                </form>
            </div>
